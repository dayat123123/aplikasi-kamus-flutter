// ignore_for_file: constant_identifier_names, unnecessary_string_interpolations, unnecessary_const, unnecessary_new, prefer_final_fields
...
class IndoBanjarBetul extends StatefulWidget {
  ...
  @override
  State<IndoBanjarBetul> createState() => _IndoBanjarBetulState();
}

class _IndoBanjarBetulState extends State<IndoBanjarBetul> {
  ...
  void _onSpeechResult(SpeechRecognitionResult result) {
    setState(() async {
      ...
      data = await fetchdata(url =
          'https://flask-production-b796.up.railway.app/api4?query=' +
              terjemahan.toString());
