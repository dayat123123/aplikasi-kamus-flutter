...
class InggrisIndo extends StatefulWidget {
  const InggrisIndo({Key? key}) : super(key: key);

  @override
  State<InggrisIndo> createState() => _InggrisIndoState();
}

class _InggrisIndoState extends State<InggrisIndo> {
  ...
  void _onSpeechResult(SpeechRecognitionResult result) {
    setState(() {
      ...
      fetchdata(url =
          'https://vnev.herokuapp.com/api3?query=' + terjemahan.toString());
    });
  }
  // batas
              ...
              Expanded(
                child: Container(
                  ...
                  child: Form(
                    child: TextFormField(
                      onChanged: (value) {
                        url = 'https://vnev.herokuapp.com/api3?query=' +
                            value.toString();
                      },
